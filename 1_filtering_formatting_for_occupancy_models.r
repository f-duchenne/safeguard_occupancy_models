...
#redefine country level:
dat[,COUNTRY2:=COUNTRY]

dat[COUNTRY=="Andorra",COUNTRY2:="Spain"]
dat[COUNTRY=="Spain",COUNTRY2:="Spain"]

dat[COUNTRY=="Cyprus",COUNTRY2:="Turkey"]

dat[COUNTRY=="Monaco",COUNTRY2:="France"]
dat[COUNTRY=="Guernsey",COUNTRY2:="France"]
dat[COUNTRY=="Jersey",COUNTRY2:="France"]

dat[COUNTRY=="Malta",COUNTRY2:="Italy"]
dat[COUNTRY=="Holy See",COUNTRY2:="Italy"]
dat[COUNTRY=="San Marino",COUNTRY2:="Italy"]

dat[COUNTRY=="Isle of Man",COUNTRY2:="U.K. of Great Britain and Ireland"]
dat[COUNTRY=="Ireland",COUNTRY2:="U.K. of Great Britain and Ireland"]
dat[COUNTRY=="U.K. of Great Britain and Northern Ireland",COUNTRY2:="U.K. of Great Britain and Ireland"]

dat[COUNTRY=="Luxembourg",COUNTRY2:="Benelux"]
dat[COUNTRY=="Belgium",COUNTRY2:="Benelux"]
dat[COUNTRY=="Netherlands",COUNTRY2:="Benelux"]

dat[COUNTRY=="Liechtenstein",COUNTRY2:="Switzerland"]

dat[COUNTRY=="Montenegro" ,COUNTRY2:="Albania-Montenegro-Macedonia"]
dat[COUNTRY=="Albania" ,COUNTRY2:="Albania-Montenegro-Macedonia"]
dat[COUNTRY=="North Macedonia" ,COUNTRY2:="Albania-Montenegro-Macedonia"]
...
#create the matrix
mat1=dcast(dat,survey+list_length+YEAR_2+time_period+site+COUNTRY2~species)

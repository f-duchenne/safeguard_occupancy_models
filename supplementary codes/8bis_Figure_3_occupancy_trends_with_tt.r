...
#load trends
trendsf=fread(paste0(project_folder,"data/final_and_intermediate_outputs/all_trends_with_tt_with_GBIF.csv"))
...
for(jj in unique(bidon$taxo_group)){
  load(paste0(project_folder,"data/final_and_intermediate_outputs/models/model_with_tt_with_GBIF_",1921,"_",jj,".RData"))
	model_1=lis_bas[[1]]
	model_2=lis_bas[[2]]
	sav <- emmprep(model_1)
	...
	load(paste0(project_folder,"data/final_and_intermediate_outputs/models/model_total_with_tt_with_GBIF_",1921,"_",jj,".RData"))
	model_1=lis_bas[[1]]
	model_2=lis_bas[[2]]
	sav <- emmprep(model_1)
	...
	load(paste0(project_folder,"data/final_and_intermediate_outputs/models/model_total_with_tt_with_GBIF_",1971,"_",jj,".RData"))
	model_1=lis_bas[[1]]
	model_2=lis_bas[[2]]
	sav <- emmprep(model_1)
	b=as.data.frame(emmeans(sav,specs="1"))
...
#fwrite(table_S2,paste0(project_folder,"data/final_and_intermediate_outputs/table_S2_with_tt_with_GBIF.csv"))
...
pdf(paste0(project_folder,"figures/Figure_3_with_tt_with_GBIF.pdf"),width=8,height=5)
grid.arrange(p1,pl5,ncol=2,widths=c(2,1))
dev.off();

...
lifile=list.files(path="results/predicts_linear_with_tt_with_GBIF/", pattern ="predicts_",full.names =TRUE)
...
liste_original=fread(paste0(project_folder,"data/final_and_intermediate_outputs/liste_total_species_occupancy_with_GBIF.csv"))
...
fwrite(trendsf,paste0(project_folder,"data/final_and_intermediate_outputs/all_trends_with_tt_with_GBIF.csv"))

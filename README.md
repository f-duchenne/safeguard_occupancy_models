...
Occupancy models were fitted using an approach based on what was has been done in the *sparta* package (https://github.com/BiologicalRecordsCentre/sparta). However, as our list of species wsa too important to run the data preparation and models using *sparta*, we used customized code, taking advantage of the facilities provided by the *data.table* R package to improve performance.
